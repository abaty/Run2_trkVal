...
void validationPlots()
{
  ...
  //algo can be 0 for all, or 4,5,6,7, etc
  int doOneAlgo = 7;
  ...
  {
    tree[0] = (TTree*)fDa->Get(Form("algo%dOnline/trackTree",doOneAlgo));
    tree[1] = (TTree*)fDa->Get(Form("algo%dOffline/trackTree",doOneAlgo));
  }
  TTree * hiBinTree[2];
...
//  mcHiBin->Divide(daHiBin);
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c1[j]->SaveAs(Form("validationPlots%d/chi2_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c2[j]->SaveAs(Form("validationPlots%d/dxy_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c3[j]->SaveAs(Form("validationPlots%d/dz_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c4[j]->SaveAs(Form("validationPlots%d/nhit_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c5[j]->SaveAs(Form("validationPlots%d/nlayer_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c6[j]->SaveAs(Form("validationPlots%d/eta_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c7[j]->SaveAs(Form("validationPlots%d/pterr_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c8[j]->SaveAs(Form("validationPlots%d/mva_%d.png",doOneAlgo,j));
  }
  ...
  for(int j = 0; j<2; j++)
  {
    ...
    c9[j]->SaveAs(Form("validationPlots%d/mvaRat_%d.png",doOneAlgo,j));
  }
